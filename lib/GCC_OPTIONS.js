...
GCC_OPTIONS['C Language Options'] = '\
    -ansi  -std=<standard>  -fgnu89-inline -aux-info <filename> -fallow-parameterless-variadic-functions -fno-asm  -fno-builtin\
    -fno-builtin-<function> -fhosted  -ffreestanding -fopenmp -fopenmp-simd -fms-extensions -fplan9-extensions -trigraphs  -traditional\
...
GCC_OPTIONS['C++ Language Options'] = '\
   ...
   -ffor-scope  -fno-for-scope  -fno-gnu-keywords -fno-implicit-templates -fno-implicit-inline-templates -fno-implement-inlines  -fms-extensions\
...
GCC_OPTIONS['Objective-C and Objective-C++ Language Options'] = '\
...
GCC_OPTIONS['Language Independent Options'] =  '\
...
GCC_OPTIONS['Warning Options'] = '\
   ...
   -Werror  -Werror=* -Wfatal-errors  -Wfloat-equal  -Wformat  -Wformat=2 -Wno-format-contains-nul -Wno-format-extra-args -Wformat-nonliteral\
   ...
   -Winvalid-pch -Wlarger-than=<len>  -Wunsafe-loop-optimizations -Wlogical-op -Wlong-long -Wmain -Wmaybe-uninitialized -Wmemset-transposed-args\
   ...
   -Wsign-conversion -Wfloat-conversion -Wsizeof-pointer-memaccess -Wstack-protector -Wstack-usage=<len> -Wstrict-aliasing -Wstrict-aliasing=<n>\
   -Wstrict-overflow -Wstrict-overflow=<n> -Wsuggest-attribute=[pure|const|noreturn|format] -Wmissing-format-attribute -Wswitch  -Wswitch-default\
...
GCC_OPTIONS['C and Objective-C-only Warning Options'] = '\
...
GCC_OPTIONS['Debugging Options'] = '\
   ...
   -fdisable-rtl-<pass_name> -fdisable-rtl-<pass-name>=<range-list> -fdisable-tree-<pass_name> -fdisable-tree-<pass-name>=<range-list> -fdump-noaddr\
   ...
   -fdump-tree-nrv -fdump-tree-vect -fdump-tree-sink -fdump-tree-sra[-<n>] -fdump-tree-forwprop[-<n>] -fdump-tree-fre[-<n>] -fdump-tree-vtable-verify\
   ...
   -fno-eliminate-unused-debug-types -feliminate-unused-debug-symbols -femit-class-debug-always -fenable-<kind>-<pass> -fenable-<kind>-<pass>=<range-list>\
...
GCC_OPTIONS['Optimization Options'] = '\
   ...
   -fprofile-generate -fprofile-generate=<path> -fprofile-use -fprofile-use=<path> -fprofile-values -fprofile-reorder-functions -freciprocal-math\
...
GCC_OPTIONS['Preprocessor Options'] = '\
   -A<question>=<answer> -A-<question>[=<answer>] -C  -dD  -dI  -dM  -dN -D<macro>[=<defn>]  -E  -H -idirafter <dir> -include <file>  -imacros <file> -iprefix\
   <file>  -iwithprefix <dir> -iwithprefixbefore <dir>  -isystem <dir> -imultilib <dir> -isysroot <dir> -M  -MM  -MF  -MG  -MP  -MQ  -MT  -nostdinc -P\
...
GCC_OPTIONS['Machine Dependent Options'] =  {}; //FIXME : do we need to parse options for all machines?

GCC_OPTIONS['Machine Dependent Options']['ARM Options'] = '\
   -mapcs-frame  -mno-apcs-frame -mabi=<name> -mapcs-stack-check  -mno-apcs-stack-check -mapcs-float  -mno-apcs-float -mapcs-reentrant\
   -mno-apcs-reentrant -msched-prolog  -mno-sched-prolog -mlittle-endian  -mbig-endian  -mwords-little-endian -mfloat-abi=<name>\
   -mfp16-format=<name> -mthumb-interwork  -mno-thumb-interwork -mcpu=<name>  -march=<name>  -mfpu=<name> -mstructure-size-boundary=<n>\
   -mabort-on-noreturn -mlong-calls  -mno-long-calls -msingle-pic-base  -mno-single-pic-base -mpic-register=<reg> -mnop-fun-dllimport\
...
GCC_OPTIONS['Machine Dependent Options']['Darwin Options'] = '\
   -all_load  -allowable_client  -arch  -arch_errors_fatal -arch_only  -bind_at_load  -bundle  -bundle_loader -client_name\
   ...
   -sectobjectsymbols  -sectorder -segaddr -segs_read_only_addr -segs_read_write_addr -seg_addr_table  -seg_addr_table_filename  -seglinkedit\
   -segprot  -segs_read_only_addr  -segs_read_write_addr -single_module  -static  -sub_library  -sub_umbrella -twolevel_namespace  -umbrella\
...
GCC_OPTIONS['Machine Dependent Options']['GNU/Linux Options'] = '\
   -mglibc -muclibc -mbionic -mandroid -tno-android-cc -tno-android-ld';

GCC_OPTIONS['Machine Dependent Options']['i386 and x86-64 Options'] = '\
...
GCC_OPTIONS['Machine Dependent Options']['i386 and x86-64 Windows Options'] = '\
