...
GCC_OPTIONS['Preprocessor Options'] = '\
   ...
   -no-integrated-cpp -F<dir> -iframework <dir>';
...
GCC_OPTIONS['Machine Dependent Options'] += '\
   ...
   -undefined -unexported_symbols_list  -weak_reference_mismatches -whatsloaded -gused -gfull -mmacosx-version-min=<version> -mkernel\
   -mone-byte-bool';
...
GCC_OPTIONS['Machine Dependent Options'] += '\
   --target=<target>';
//clang way. FIXME : move to CLANG_OPTIONS.js later
GCC_OPTIONS['Machine Dependent Options'] += '\
   -target <target>';
...
// FIXME : DiagnosticSerializationFile is generated during Clang's Preprocessing
// so do not need to send it to daemons.
// '--serialize-diagnostics' option is in Clang, not GCC.
// more info on http://clang.llvm.org/doxygen/classclang_1_1DiagnosticOptions.html
GCC_OPTIONS['Diagnostic Options'] = '\
