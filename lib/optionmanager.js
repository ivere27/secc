...
var OptionManager = function() {
  ...
  //console.log(this.gccOptionsIndex);
};
...
//console.log(parsingGccOption(GCC_OPTIONS, 'Code Generation Options'));
//console.log(parsingGccOption(GCC_OPTIONS['Machine Dependent Options'], 'GNU/Linux Options'));
//new OptionManager();
